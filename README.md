...
Die aktuelle Version findest du unter **Releases**:

➡️ [Kitar Companion herunterladen](https://github.com/Colvar91/Kitar-Companion/releases/latest)

## Installation

1. Öffne die Seite **Releases**.
2. Lade die aktuelle Version herunter.
3. Entpacke bzw. installiere die heruntergeladene Version entsprechend dem enthaltenen Projektaufbau.
...
Weitere Informationen zu Funktionen, Bedienung und Voraussetzungen können hier mit zukünftigen Releases ergänzt werden.

## Lizenz

Sofern keine separate Lizenzdatei vorhanden ist, bleiben alle Rechte beim jeweiligen Autor.
